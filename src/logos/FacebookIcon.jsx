...
function FacebooIcon(){

	return (
		<svg xmlns="http://www.w3.org/2000/svg" height="40" width="40" stroke="white" strokeWidth="35" 
		viewBox="0 0 512 512" 
className="fill-none hover:fill-white transition ease-in-out hover:translate-y-1 scale-110 delay-150 duration-300 rounded-full">
